...
p1 = threading.Thread(target=translate_parallel, args=[df_new1])
p2 = threading.Thread(target=translate_parallel, args=[df_new2])
p3 = threading.Thread(target=translate_parallel, args=[df_new3])
p4 = threading.Thread(target=translate_parallel, args=[df_new4])
